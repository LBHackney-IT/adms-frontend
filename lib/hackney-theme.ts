export const hackneyColors = {
  // Hackney Brand Colors - A Series (Greens)
  "lbh-a01": "#00664f",
  "lbh-a02": "#00b341",
  "lbh-a03": "#84bd00",
  "lbh-a04": "#a4d65e",

  // Hackney Brand Colors - E Series (Magentas)
  "lbh-e01": "#672146",
  "lbh-e02": "#aa0061",
  "lbh-e03": "#df1995",
  "lbh-e04": "#eb6fbd",

  // Hackney Brand Colors - F Series (Reds/Oranges)
  "lbh-f01": "#81312f",
  "lbh-f02": "#be3a34",
  "lbh-f03": "#e03c31",
  "lbh-f04": "#ff6a13",

  // Hackney Brand Colors - H Series (Yellows)
  "lbh-h04": "#f8e08e",
